...
dat$treat <- dat$id
dat$treat <- mapvalues(dat$treat, from = c('1', '10', '15'), to = c(rep('C', 3)))
dat$treat <- mapvalues(dat$treat, from = c('2', '12', '14'), to = c(rep('G', 3)))
dat$treat <- mapvalues(dat$treat, from = c('3', '7', '18'), to = c(rep('H', 3)))
dat$treat <- mapvalues(dat$treat, from = c('6', '11', '17'), to = c(rep('A', 3)))
dat$treat <- mapvalues(dat$treat, from = c('4', '8', '13'), to = c(rep('I', 3)))
...
# write.xlsx(dat.table, file = '../ALFAM2 submission/dat_22I.xlsx')
