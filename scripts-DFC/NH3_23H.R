...
dat$treat <- dat$id
dat$treat <- mapvalues(dat$treat, from = c('1', '12', '15'), to = c(rep('F', 3)))
dat$treat <- mapvalues(dat$treat, from = c('2', '7', '17'), to = c(rep('D', 3)))
dat$treat <- mapvalues(dat$treat, from = c('3', '10', '13'), to = c(rep('E', 3)))
dat$treat <- mapvalues(dat$treat, from = c('6', '11', '18'), to = c(rep('A', 3)))
dat$treat <- mapvalues(dat$treat, from = c('4', '8', '14'), to = c(rep('B', 3)))
...
# write.xlsx(dat.table, file = '../ALFAM2 submission/dat_22H.xlsx')
