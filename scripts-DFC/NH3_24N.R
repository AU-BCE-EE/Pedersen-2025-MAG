...
dat$treat <- dat$id
dat$treat <- mapvalues(dat$treat, from = c('1', '2', '3', '4'), to = c(rep('TS-TSBacid', 4)))
dat$treat <- mapvalues(dat$treat, from = c('6', '7', '8', '10'), to = c(rep('OSI', 4)))
dat$treat <- mapvalues(dat$treat, from = c('11', '12', '13', '14'), to = c(rep('TS-TSB', 4)))
dat$treat <- mapvalues(dat$treat, from = c('15', '17', '18', '19'), to = c(rep('TH', 4)))

dat$replicate <- dat$id
dat$replicate <- mapvalues(dat$replicate, from = c('1', '6', '11', '15'), to = rep('1', 4))
dat$replicate <- mapvalues(dat$replicate, from = c('2', '7', '12', '17'), to = rep('2', 4))
dat$replicate <- mapvalues(dat$replicate, from = c('3', '8', '13', '18'), to = rep('3', 4))
dat$replicate <- mapvalues(dat$replicate, from = c('4', '10', '14', '19'), to = rep('4', 4))
...
dat[dat$id == '2', ]$elapsed.time <- dat[dat$id == '1', ]$elapsed.time
dat[dat$id == '3', ]$elapsed.time <- dat[dat$id == '1', ]$elapsed.time
dat[dat$id == '4', ]$elapsed.time <- dat[dat$id == '1', ]$elapsed.time
dat[dat$id == '5', ]$elapsed.time <- dat[dat$id == '1', ]$elapsed.time
dat[dat$id == '6', ]$elapsed.time <- dat[dat$id == '1', ]$elapsed.time
dat[dat$id == '7', ]$elapsed.time <- dat[dat$id == '1', ]$elapsed.time
dat[dat$id == '8', ]$elapsed.time <- dat[dat$id == '1', ]$elapsed.time
dat[dat$id == '9', ]$elapsed.time <- dat[dat$id == '1', ]$elapsed.time[1:55]
dat[dat$id == '10', ]$elapsed.time <- dat[dat$id == '1', ]$elapsed.time[1:55]
dat[dat$id == '11', ]$elapsed.time <- dat[dat$id == '1', ]$elapsed.time[1:55]
dat[dat$id == '12', ]$elapsed.time <- dat[dat$id == '1', ]$elapsed.time[1:55]
dat[dat$id == '13', ]$elapsed.time <- dat[dat$id == '1', ]$elapsed.time[1:55]
dat[dat$id == '14', ]$elapsed.time <- dat[dat$id == '1', ]$elapsed.time[1:55]
dat[dat$id == '15', ]$elapsed.time <- dat[dat$id == '1', ]$elapsed.time[1:55]
dat[dat$id == '16', ]$elapsed.time <- dat[dat$id == '1', ]$elapsed.time[1:55]
dat[dat$id == '17', ]$elapsed.time <- dat[dat$id == '1', ]$elapsed.time[1:55]
dat[dat$id == '18', ]$elapsed.time <- dat[dat$id == '1', ]$elapsed.time[1:55]
dat[dat$id == '19', ]$elapsed.time <- dat[dat$id == '1', ]$elapsed.time[1:55]

# removing data at et = 48.2 and 50.7 as slurry was applied in the field and that disturbed the measurements 
dat <- dat[! dat$elapsed.time == '45.7', ]
dat <- dat[! dat$elapsed.time == '48.2', ]
dat <- dat[! dat$elapsed.time == '50.7', ]
...
weather$date.time.weather <- as.POSIXct(weather$date, format = "%Y-%m-%d %H:%M", tz = "UTC")

dat$date.time.weather <- as.POSIXct(paste(dat$st), format = "%Y-%m-%d %H:%M", tz = "UTC")
...
dat$exp <- '24N'                # CHANGE CHANGE CHANGE
dat$field <- 'Varde1'       # CHANGE CHANGE CHANGE
...
dat.table <- dat[, c(39:77)]

write.xlsx(dat.table, file = '../ALFAM2 submission/dat_24N.xlsx')
