...
dat[dat$id == '9', ]$elapsed.time <- dat[dat$id == '1', ]$elapsed.time
dat[dat$id == '10', ]$elapsed.time <- dat[dat$id == '1', ]$elapsed.time
dat[dat$id == '11', ]$elapsed.time <- dat[dat$id == '1', ]$elapsed.time
dat[dat$id == '12', ]$elapsed.time <- dat[dat$id == '1', ]$elapsed.time[1:36]
dat[dat$id == '13', ]$elapsed.time <- dat[dat$id == '1', ]$elapsed.time[1:36]
dat[dat$id == '14', ]$elapsed.time <- dat[dat$id == '1', ]$elapsed.time[1:36]
dat[dat$id == '15', ]$elapsed.time <- dat[dat$id == '1', ]$elapsed.time[1:36]
dat[dat$id == '16', ]$elapsed.time <- dat[dat$id == '1', ]$elapsed.time[1:36]
dat[dat$id == '17', ]$elapsed.time <- dat[dat$id == '1', ]$elapsed.time[1:36]
dat[dat$id == '18', ]$elapsed.time <- dat[dat$id == '1', ]$elapsed.time[1:36]
dat[dat$id == '19', ]$elapsed.time <- dat[dat$id == '1', ]$elapsed.time[1:36]
...
dat$exp <- '24O'                # CHANGE CHANGE CHANGE
dat$field <- 'Varde2'       # CHANGE CHANGE CHANGE
...
write.xlsx(dat.table, file = '../ALFAM2 submission/dat_24O.xlsx')
