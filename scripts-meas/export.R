...
isumm3 <- isumm[is.element(isumm$new.ID, c('D1', 'D2', 'D3', 'D4', 'D5')), c('new.ID', 'treat1', 'e.rel.150', 'e.rel.8')]
...
esumm.prop.supMat <- esumm[is.element(esumm$new.ID, c('D1', 'D2', 'D3', 'D4', 'D5')), c('new.ID', 'treat1', 'e.rel.150', 'e.rel.8')] 
