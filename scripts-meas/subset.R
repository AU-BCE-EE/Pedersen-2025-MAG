...
idat$new.ID <- gsub('24B', '5', idat$new.ID)
idat$new.ID <- gsub('24H', '6', idat$new.ID)
idat$new.ID <- gsub('24C', '7', idat$new.ID)
idat$new.ID <- gsub('24D', '8', idat$new.ID)
idat$new.ID <- gsub('24J', '9', idat$new.ID)
idat$new.ID <- gsub('24L', '10', idat$new.ID)
