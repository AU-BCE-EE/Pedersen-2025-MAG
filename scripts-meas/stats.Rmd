...
Check for interaction likelihood ratio test.
...
```{r}
mmeans1_4$tabval <- paste(100 * signif(mmeans1_4$emmean, 3), gsub(' ', '', mmeans1_4$.group))
```
...
```{r}
mmeans5_10$tabval <- paste(100 * signif(mmeans5_10$emmean, 3), gsub(' ', '', mmeans5_10$.group))
```
