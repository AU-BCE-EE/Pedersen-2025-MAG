...
```{r}
mlm1 <- lm(e.rel.150 ~ TS.mn + pH.lab.mn + log10(K.mn) + n.mn + slurry.ID + trial.ID, data = ds)
summary(mlm1)
anova(mlm1)
drop1(mlm1, test = 'F')
```
...
```{r}
mmm4 <- lmer(e.rel.150 ~ TS.mn + pH.lab.mn + log10(K.mn) + n.mn + (1|trial.ID), data = ds)
summary(mmm4)
...
```{r}
mmm5 <- lmer(e.rel.150 ~ TS.mn + pH.lab.mn + log10(K.mn) + (1|trial.ID), data = ds)
summary(mmm5)
...
```{r}
mmm6 <- lmer(e.rel.150 ~ TS.mn + pH.lab.mn + n.mn + (1|trial.ID), data = ds)
summary(mmm6)
...
```{r}
mmm6 <- lmer(e.rel.150 ~ TS.mn + pH.lab.mn + log10(K.mn) + n.mn + mm2.mn + area.perc.mn + (1|trial.ID), data = ds)
summary(mmm6)
drop1(mmm6, test = 'Chisq')
```
...
```{r}
mmm7 <- lmer(e.rel.150 ~ pH.lab.mn + log10(K.mn) + n.mn + mm2.mn + area.perc.mn + (1|trial.ID), data = ds)
summary(mmm7)
...
```{r}
mmm8 <- lmer(e.rel.150 ~ log10(K.mn) + n.mn + mm2.mn + area.perc.mn + (1|trial.ID), data = ds)
summary(mmm8)
...
```{r}
mmm10 <- lmer(e.rel.150 ~ TS.mn + pH.lab.mn + log10(K.mn) + mm2.mn + (1|trial.ID), data = ds)
summary(mmm10)
...
```{r}
mlm7 <- lm(e.rel.150 ~ TS.mn + pH.lab.mn + log10(K.mn) + mm2.mn, data = ds)
summary(mlm7)
drop1(mlm7, test = 'F')
```
...
```{r}
mmm6 <- lmer(e.rel.150 ~ TS.mn + pH.lab.mn + log10(K.mn) + (1|trial.ID) + (1|slurry.type), data = ds)
summary(mmm6)
drop1(mmm6, test = 'Chisq')
...
```{r}
mmm4 <- lmer(e.rel.150 ~ TS.mn + pH.lab.mn + log10(K.mn) + n.mn + (1|trial.ID), data = dsd)
summary(mmm4)
drop1(mmm4, test = 'Chisq')
```
...
```{r}
mmm6 <- lmer(e.rel.150 ~ TS.mn + pH.lab.mn + log10(K.mn) + n.mn + mm2.mn + area.perc.mn + (1|trial.ID), data = dsd)
summary(mmm6)
drop1(mmm6, test = 'Chisq')
```
...
```{r}
mmm7 <- lmer(e.rel.150 ~ pH.lab.mn + log10(K.mn) + n.mn + mm2.mn + area.perc.mn + (1|trial.ID), data = dsd)
summary(mmm7)
drop1(mmm7, test = 'Chisq')
```

```{r}
mmm8 <- lmer(e.rel.150 ~ log10(K.mn) + n.mn + mm2.mn + area.perc.mn + (1|trial.ID), data = dsd)
summary(mmm8)
drop1(mmm8, test = 'Chisq')
```
